...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,932565396,2042257789}
...
var = true  
elseif tonumber(user_id) == tonumber(2042257789) then
var = true  
...
local NameUser = "[- 𝖲𝗈𝗎𝗋𝖼𝖾 SHaHuM .](https://t.me/SouRceSHaHuM)\n — — — — — — — — —\n‹ : بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- 𝖲𝗈𝗎𝗋𝖼𝖾 SHaHuM .](https://t.me/SouRceSHaHuM)\n — — — — — — — — —\n‹ : اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
inlin = {{{text = '- انقر للحذف.',callback_data=msg.sender_user_id_..":cancelRd:del"}}, }
...
if result.id_ == tonumber(2042257789) then
send(msg.chat_id_, msg.id_, "‹ : لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(2042257789) then
send(msg.chat_id_, msg.id_, "‹ : لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
send(msg.chat_id_, msg.id_,"[- 𝖲𝗈𝗎𝗋𝖼𝖾 SHaHuM .](https://t.me/SouRceSHaHuM)\n — — — — — — — — —\n‹ : العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "SouRceSHaHuM")..")".."\n‹ : تم رفعه "..RTPA.." هنا\n")
...
if result.sender_user_id_ == tonumber(2042257789) then
send(msg.chat_id_, msg.id_, "‹ : لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
if userid == tonumber(2042257789) then
send(msg.chat_id_, msg.id_, "‹ : لا يمكن { حظر،كتم،طرد،تقيد،الخ ..} مطور السورس \n")
return false 
end
...
inline = {{{text = '- انقر للحذف.',callback_data=msg.sender_user_id_..":cancelRd:del"}}, }
...
local get_id = get_id:gsub('#game',Num_Games) 
local get_id = get_id:gsub('#photos',Total_Photp) 
inline = {{{text = '- انقر للحذف.',callback_data=msg.sender_user_id_..":cancelRd:add"}}, }
...
database:set(bot_id.."korpica:Qut"..msg.chat_id_,true)
end
if text == "تفعيل كت تويت" and Owner(msg) then
send(msg.chat_id_, msg.id_,'‹ :  تم تفعيل كت تويت')
database:del(bot_id.."korpica:Qut"..msg.chat_id_)
end
if text == "كت" or  text == "كت تويت" and not  database:get(bot_id.."korpica:Qut"..msg.chat_id_) then
...
if text == "الابراج" and database:get(bot_id.."korpica:brj_Bots"..msg.chat_id_) == "open" then
key = {
...
if database:get(bot_id.."korpica:insta_bot"..msg.chat_id_) == "open" then
...
{
{text = '❲ Coder ❳', url = "https://t.me/TttttX"}
},
{
...
x = {} 
x.inline_keyboard = {
{{text = '‹ : SHaHuM 𝖲𝗈𝗎R𝖼𝖾 .',url='http://t.me/SouRceSHaHuM'}},
}
...
inline = {
{{text = '‹ :  SouRce SHaHuM  .',url='http://t.me/SouRceSHaHuM'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
...
if database:get(bot_id.."korpica:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_) then
database:del(bot_id.."korpica:Set:Manager:rd"..data.sender_user_id_..":"..data.chat_id_)
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
...
>>Source developer > @TttttX
   _____ _    _       _    _       __  __  _____             _____          
  / ____| |  | |     | |  | |     |  \/  |/ ____|           |  __ \         
 | (___ | |__| | __ _| |__| |_   _| \  / | (___   ___  _   _| |__) |___ ___ 
  \___ \|  __  |/ _` |  __  | | | | |\/| |\___ \ / _ \| | | |  _  // __/ _ \
  ____) | |  | | (_| | |  | | |_| | |  | |____) | (_) | |_| | | \ \ (__  __/
 |_____/|_|  |_|\__,_|_|  |_|\__,_|_|  |_|_____/ \___/ \__,_|_|  \_\___\___|
